...
java -cp "bin;guava-14.0.1.jar" Dictconvert_with_elements ../../ebu-bmx/meta/as11/as11_mxflib_dict.xml "urn:dpp:metadata:as11" key_ns_as11_1 > ../src/group_declarations_as11.inc
